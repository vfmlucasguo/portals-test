...
exports.commandsObject = yargs
    ...
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield (yield Promise.resolve().then(() => require('./affected'))).affected('graph', Object.assign({}, args));
        process.exit(0);
    }),
})
    .command({
    ...
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield (yield Promise.resolve().then(() => require('./dep-graph'))).generateGraph(args, []);
        process.exit(0);
    }),
})
    .command({
