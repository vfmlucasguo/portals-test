...
function addProjectDependencies(tree, options) {
    if (options.bundler == 'esbuild') {
        return (0, devkit_1.addDependenciesToPackageJson)(tree, {}, { '@nrwl/esbuild': versions_1.nxVersion });
    }
    if (options.bundler == 'rollup') {
        return (0, devkit_1.addDependenciesToPackageJson)(tree, {}, { '@nrwl/rollup': versions_1.nxVersion });
    }
